...
BOT_NAME = getenv("BOT_NAME" , "𓆩͟🌸𝆺꯭𝅥‌ٖٖٖٖٖٜ⃟ ͟🅝︎͕͜͝Ⓞ︎͕֟፝͜͝Ⓞ︎͕͜͜͝🅡︎͕͜͝ 𝆺꯭𝅥‌ٖٖٖٖٖٜ⃟🌸͟𓆪")
...
SUDO_USERS = [6727962511]

UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/surajislam/AROHI",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://graph.org/file/bd5a086516e474eb4757c.jpg"
)
PING_IMG_URL = getenv(
